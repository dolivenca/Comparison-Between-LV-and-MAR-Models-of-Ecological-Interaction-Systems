...
# save(MAR_artData1_noisy, file = "MAR_artData1_noisy_2.Rdata")
 load(file = "MAR_artData1_noisy_2.Rdata")
...
# uncoment the next lines to find the point subsample
#AlgPointFind(
...
# save(MAR_artData1_clustered, file = "MAR_artData1_clustered_2.Rdata")
 load(file = "MAR_artData1_clustered_2.Rdata")
...
# uncomment to find the point subsample
#AlgPointFind(
#		smoother_out_APF = smoother_out,
#		dif_equations = Equations,
#		matrixEq = TRUE
...
#############################################################################
##### figure S8 - noisy and clustered MAR data 20% - alg1

# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\8_methods_of_ecology_and_evolution_2sub\\paper_scripts")     # P51
# MAR_artData1_noisy = read.csv('MAR_artData1_noisy.csv')
