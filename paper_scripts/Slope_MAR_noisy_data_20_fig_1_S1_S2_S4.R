...
for ( i in 2:5 )
	{
	plot(out1[,1],out1[,i],type='p',pch=20,col=colorPallet[2],xlim=c(0,length(out1[,1])),ylim=c(0,3),xlab='t',main=mainLab[i-1],ylab=varNames[i-1],cex.lab=1.5,cex.axis=1.5,lwd=1)
...
for (i in 2:5)
	{
	plot(data1[,1],data1[,i],pch=20,col=colorPallet[2],ylim=c(0,3),main=mainLab[i-1],xlab='t',ylab=varNames[i-1],cex.lab=1.5,cex.axis=1.5,lwd=1)
...
for (i in 1:4)
	...
	plot(out1[,1],out1[,2],pch=20,col=colorPallet[2],ylim=c(0,3),main=mainLab[i],xlab='t',ylab='X1',cex.lab=1.5,cex.axis=1.5,lwd=1)
...
# "100 % complete || DF = 5 8 11 5  ||  3 6 14 21 27 20.628  ||  3 6 14 21 27 2.505"
...
# SSE
sum( ( out1[,2:5] - out_est_noisydata3_alg1[,2:5] )^2 )
