...
sum((out1[,2:5] - MARest3_orig[,2:5])^2)
...
sum((out1[,2:5] - MARest4_orig[,2:5])^2)
...
for (i in 2:5)
	...
	points(MARest1_smoothData$MAR_TS_Est[,i-1],col='orange',type='l',lty=1,lwd=3)
	points(MARest2_smoothData$MAR_TS_Est[,i-1],col='khaki',type='l',lty=1,lwd=3)
...
for (i in 2:5)
	...
	points(MARest3_smoothData$MAR_TS_Est[,i-1],col='orange',type='l',lty=1,lwd=3)
	points(MARest4_smoothData$MAR_TS_Est[,i-1],col='khaki',type='l',lty=1,lwd=3)
