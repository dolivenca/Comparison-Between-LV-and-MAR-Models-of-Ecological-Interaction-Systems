...
legend(.7,1.3,legend = c('data','Mühlbauer est','Slope est','MAR','MAR logTrans'),lty = c(NA,1,1,1,1),lwd=c(NA,3,3,3,3),pch = c(1,NA,NA,NA,NA,NA),col = colorPallet,bty = "n",cex=.8) # ,
# dev.off()
